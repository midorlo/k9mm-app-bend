package com.midorlo.wolkenbruch.service;
...
public abstract class ApplicationService<
   ...
   public ApplicationService(R repository) {
   ...
   public E create(E entity) {
      ...
      ApplicationService.log.info("Creating {}", entity);
   ...
   public E update(E entity) {
      ApplicationService.log.info("Update Requested: {}", entity.toString());
      ...
      ApplicationService.log.info("Updating {} to {}", entityById, entity);
      return repository.save(entity);
   }
}
