...
import static com.midorlo.wolkenbruch.configuration.ApplicationConstants.APPLICATION_PROPERTIES_BASE;

/**
 * Shade over the section "wolkenbruch" within the application.yml resource file.
 */
@Configuration
@ConfigurationProperties(prefix = APPLICATION_PROPERTIES_BASE)
@Data
