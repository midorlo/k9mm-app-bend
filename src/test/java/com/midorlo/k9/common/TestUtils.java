...
public final class TestUtils {
   ...
   public static MockHttpServletRequestBuilder post(String uri, Object payload) throws IOException {
      return MockMvcRequestBuilders.post(uri).contentType(MediaType.APPLICATION_JSON)
                                   .content(TestUtils.convertObjectToJsonBytes(payload));
   }
    ...
    */
   public static <T> void jpaEqualsVerifier(Class<T> clazz) throws Exception {

      T o1 = clazz.getConstructor().newInstance();
      T o2 = clazz.getConstructor().newInstance();

      assertThat(o1.toString()).isNotNull();

      assertThat(o1).isEqualTo(o1);
      assertThat(o1).hasSameHashCodeAs(o1);

      Object testOtherObject = new Object();
      assertThat(o1).isNotEqualTo(testOtherObject);
      assertThat(o1).isNotEqualTo(null);

      T domainObject2 = clazz.getConstructor().newInstance();
      assertThat(o1).isNotEqualTo(domainObject2);
      assertThat(o1).hasSameHashCodeAs(domainObject2);
   }
   ...
   /**
    * Executes a query to the EntityManager finding all stored objects.
    *
